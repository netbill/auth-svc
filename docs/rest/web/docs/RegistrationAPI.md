...
func main() {
	registrationAdmin := *openapiclient.NewRegistrationAdmin(*openapiclient.NewRegistrationAdminData("Type_example", *openapiclient.NewRegistrationAdminDataAttributes("example1312@gmail.com", "StrongP@ssw0rd!", "johndoe123", "admin"))) // RegistrationAdmin | 
...
func main() {
	registration := *openapiclient.NewRegistration(*openapiclient.NewRegistrationData("Type_example", *openapiclient.NewRegistrationDataAttributes("example@gmail.com", "StrongP@ssw0rd!", "johndoe123"))) // Registration | 
